    ...
    public class Player : LivingCreature
    {
        ...
        {  
                ...
                
            {
                ...
                {
                    System.Console.WriteLine("You must have a {0} to enter this location.", location.ItemRequiredToEnter.Name);
                    return;
                }
            }
            ...
            //Heal the player (each move)
            CurrentHitPoints = MaximumHitPoints;

            CurrentLocation = location;
            WhereAmI();

            //Add Quests, Monsters here
            GameEngine.QuestProcessor(this, location);
            GameEngine.MonsterProcessor(this, location);
